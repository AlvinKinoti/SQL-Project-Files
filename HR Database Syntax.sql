...
-- source data = (https://www.sqltutorial.org/wp-content/uploads/2020/04/sqlserver.txt)
-- source data = (https://www.sqltutorial.org/wp-content/uploads/2020/04/sqlserver-data.txt) 
